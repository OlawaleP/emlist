...
const page = () => {
  return (
    <main className="relative w-full h-screen flex justify-center items-center padding-x ">
      <div className="max-w-[504px] w-[504px] h-screen py-10 flex flex-col items-start max-sm:w-full">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-end">
              <Link
                ...
                className="capitalize text-[16px] font-[600] text-[#303632] leading-[24px] max-sm:text-[13px] py-2 hover:text-primary-green"
              >
                Forgot Password?
              </Link>
            </div>
        ...
        <div className="w-full flex items-center justify-between py-8 max-sm:py-4">
        ...
        <button className="flex justify-center items-center w-full border-[1px] rounded-[10px] h-[50px] max-sm:min-h-[46px] border-[#1A201B] text-[#737774] text-[18px] font-[600] max-sm:text-[14px] mb-6">
        ...
        <div className="w-full flex justify-center pt-10 max-sm:py-5 ">
