...
const ApplicationDetailsContent = () => {
  return (
    <section className="py-28 padding-x bg-[#F0FDF5]">
      <div className="grid grid-cols-12 pb-10 gap-6">
        <div className="col-span-12 ">
          <div className="flex justify-between items-center bg-[#DDFBE9] border-primary-green border-[1px] px-[3rem] py-2 rounded-lg max-sm:flex-col max-md:px-[1rem] max-sm:px-[0.5rem]  gap-2 text-center w-full">
            {" "}
        ...
        <div className="col-span-9 max-lg:col-span-12 flelx flex-col w-full bg-white rounded-[10px] py-10 ">
          ...
          <div className="w-full border-b-[1px] border-[#B8B9B8] px-10 max-sm:px-5 py-6 flex flex-col gap-3">
            ...
            <div className="flex max-lg:flex-col items-center justify-between gap-5">
              <div className="flex items-center gap-10  max-sm:gap-5 max-lg:w-full flex-wrap">
              ...
              <div className="flex items-center max-md:justify-center max-lg:w-full gap-2">
