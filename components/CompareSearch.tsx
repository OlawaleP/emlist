...
const CompareSearch = () => {
  return (
    <div className="padding-x  ">
      <div className="flex justify-between items-center bg-[#f0fdf5] border-primary-green border-[1px] px-[3rem] py-2 rounded-lg max-sm:flex-col max-md:px-[1rem] max-sm:px-[0.5rem]  gap-2 text-center">
        {" "}
