          ...
          <div className="w-full mt-10 max-md:mt-5">
            ...
            <div className="grid grid-cols-5 gap-6 w-full ">
              <div className="col-span-3 max-lg:col-span-5 max-md:col-span-3 max-sm:col-span-5 w-full">
                <div className="w-full shadow-lg flex flex-col items-center justify-center  py-5 rounded-[10px]">
                  ...
                  <div className="flex justify-end  max-sm:justify-center col-span-4">
                    <label
                      htmlFor="profile-pic"
                      className="bg-primary-green py-[10px] px-6 my-4 text-[#fcfefd] rounded-[10px] cursor-pointer font-bold  whitespace-nowrap  text-[14px] max-lg:mt-0 max-sm:text-[11px]   "
                    >
                      Upload
                    </label>
                  </div>
              ...
              <div className="flex justify-end mb-28 mt-6 max-sm:justify-center col-span-5">
                <Link
                  href="/register/expert/pick-service"
