...
const CustomerSearch = () => {
  return (
    <form className="w-full flex items-center justify-between mb-10 shadow-lg">
      <div className="flex-1 flex items-center px-4 py-3 rounded-l-lg  border-[#b8b9b8] border-[1px] focus-within:border-primary-green max-sm:px-2 max-sm:py-2">
        <Image
      ...
      <div className="flex-1 flex items-center">
        <div className="flex items-center px-4 py-3 border-[#b8b9b8] border-y-[1px] focus-within:border-primary-green focus-within:border-[1px] max-sm:px-1 max-sm:py-2">
          <Image
