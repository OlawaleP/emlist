      ...
      <div className="grid grid-cols-12 py-10 gap-6">
        ...
        <div className="col-span-9 max-lg:col-span-12 flelx flex-col w-full bg-white rounded-[10px] py-10 ">
          ...
          <div className="flex flex-col  px-10 max-sm:px-5 w-full py-6">
            ...
            <div className="py-6">
              <div className=" flex gap-10 flex-wrap max-sm:gap-5">
                <div
            ...
            "
                >
                  <Image
                    ...
                    width={32}
                    height={32}
                    className="object-contain w-[32px] h-[32px] max-sm:w-[20px] max-sm:h-[20px] "
                  />
                  <div className="flex flex-col gap-2">
                    <h4 className=" text-[#1A201B] text-[20px] leading-[28px] font-[600] max-sm:text-[16px]">
                      Paid
                    </h4>
                    <p className=" text-[#303632] text-[16px] leading-[24px] font-[500] max-sm:text-[13px]">
                      #50,000 (Bank Transfer)
                    </p>
                    <p className="flex gap-1 items-center text-[#474C48] text-[14px] leading-[24px] font-[400] max-sm:text-[12px]">
                      {" "}
                      <Image
                        ...
                        width={18}
                        height={18}
                        className="object-contain w-[18px] h-[18px] max-sm:w-[14px] max-sm:h-[14px] "
                      />
                      23/5/2022
                    </p>
                  </div>
            ...
            "
                >
                  <div className="flex flex-col gap-2">
                    <h4 className=" text-[#1A201B] text-[16px] leading-[28px] font-[600] max-sm:text-[13px]">
                      Bank Details
                    </h4>
                    <p className=" text-[#303632] text-[16px] leading-[24px] font-[500] max-sm:text-[13px]">
                      GTBANK (0231609769)
                    </p>
                    <p className=" text-[#474C48] text-[14px] leading-[24px] font-[400] max-sm:text-[12px]">
                      {" "}
                      Victor Falade
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-4 px-10 max-sm:px-5 w-full">
            <div className="col-span-2 flex justify-end  max-sm:col-span-4 w-full max-sm:justify-center">
              <button className="bg-primary-green rounded-[10px] w-[178px] h-[52px] text-[#FCFEFD] font-[700] max-sm:w-[140px] max-sm:h-[40px] max-sm:text-[14px]">
                Close Contract
              </button>
            </div>
          </div>
